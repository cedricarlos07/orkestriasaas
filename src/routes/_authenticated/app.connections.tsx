...
function Connections() {
  const { connections, isLoading, connect, disconnect, byConnector } = useConnections();
    ...
    <div className="mx-auto max-w-[1000px] space-y-6">
      <header>
        ...
        <p className="text-[13px] text-ink-soft">
          OAuth réel requis — configurez les credentials dans .env.local puis connectez chaque plateforme.
        </p>
      </header>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[12px] text-ink-soft">
                            {connected ? conn?.externalAccount : "Non connecté"}
                          </p>
                        </div>
                      </div>
                      {connected ? (
                        ...
                        <button type="button" onClick={() => connect(cfg.id as ConnectorId)} className="btn-primary !px-3 !py-1.5 !text-[12px]">
                          Connecter
                        </button>
                      )}
                    </li>
