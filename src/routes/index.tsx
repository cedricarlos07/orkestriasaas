...
/** Colored SVG data-URI — Simple Icons CDN 404s LinkedIn / Microsoft / Amazon (brand removal). */
function brandIconDataUri(path: string, color: string) {
...
const MCP_PLATFORMS = [
  ...
  { name: "Reddit", logo: "https://cdn.simpleicons.org/reddit/FF4500", bg: "#FFEDE5" },
  {
    ...
    logo: `data:image/svg+xml;charset=utf-8,${encodeURIComponent(
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect fill="#F25022" x="1" y="1" width="10" height="10"/><rect fill="#7FBA00" x="13" y="1" width="10" height="10"/><rect fill="#00A4EF" x="1" y="13" width="10" height="10"/><rect fill="#FFB900" x="13" y="13" width="10" height="10"/></svg>',
    )}`,
    bg: "#E6F6FC",
  },
