...
const NOTES: Partial<Record<ConnectorId, string>> = {
  google_ads: "Google Ads en production (Search/PMax en pause). API native Orkestria.",
  meta_ads: "Meta en production (campagnes/annonces en pause, activation explicite). Graph API native.",
  ga4: "Analytics en lecture seule.",
  linkedin_ads: "Bientôt — création DRAFT expérimentale.",
  tiktok_ads: "Bientôt — non productisé.",
  snapchat_ads: "Bientôt — non productisé.",
  reddit_ads: "Bientôt — non productisé.",
